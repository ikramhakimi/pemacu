...
$secondary_href               = '#';
$header_container_class       = $header_container_class ?? 'container max-w-6xl mx-auto w-full px-4 text-center';
$header_topic_class           = 'header__topic  font-semibold uppercase text-brand-500';
$header_title_class           = 'header__title mt-6 max-w-xl mx-auto font-bold text-6xl text-brand-900';
$header_subtitle_class        = 'header__subtitle mt-6 max-w-2xl mx-auto text-xl text-brand-600';
$header_actions_class         = 'header__actions mt-6 flex items-center justify-center gap-2';
?>
