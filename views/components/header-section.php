...
$header_class          = $header_class ?? 'header header--section';
...
$header_topic_class    = $header_topic_class ?? 'header__topic text-xs font-semibold uppercase text-brand-500';
$header_title_class    = $header_title_class ?? 'header__title mt-4 max-w-2xl font-bold text-3xl text-brand-900';
