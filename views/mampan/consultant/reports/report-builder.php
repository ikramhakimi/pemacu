...
$export_panel = [
  'report_readiness'  => 'Builder status: 82% complete',
  'included_sections' => [
    'Executive Summary',
    'Risk Credit Notes',
    'Recommendations',
...
<article class="app-article mx-auto max-w-7xl space-y-5 py-5">
  <header class="rounded-lg border border-zinc-200 bg-white p-5" aria-labelledby="report-builder-heading">
    <div class="flex flex-wrap items-center justify-between gap-3">
      <div>
        <p class="text-xs font-semibold uppercase tracking-wide text-zinc-500">Gap Analysis Report Builder</p>
        <h1 id="report-builder-heading" class="mt-1 text-2xl font-semibold text-zinc-900 md:text-3xl">Build Report Narrative</h1>
        <p class="mt-1 text-sm text-zinc-600">Project: Menara Harmoni Office Retrofit | Version: Rev 3 Draft</p>
      </div>
  ...
  <section class="grid gap-5 xl:grid-cols-12" aria-label="Report builder layout">
    <div class="space-y-5 xl:col-span-8">
      <?php foreach ($builder_sections as $builder_section): ?>
        ...
        ?>
        <section class="rounded-lg border border-zinc-200 bg-white p-5" aria-label="<?= e($section_title); ?> editor">
          <header class="border-b border-zinc-200 pb-4">
            <div class="flex flex-wrap items-center justify-between gap-2">
              <h2 class="text-lg font-semibold text-zinc-900"><?= e($section_title); ?></h2>
              <?php component('badge', ['items' => [['label' => $section_status, 'tone' => $section_status_tone]]]); ?>
            </div>
            <p class="mt-1 text-sm text-zinc-600"><?= e($section_helper_text); ?></p>
          </header>
          ...
          <div class="mt-4 space-y-3">
            ...
            <div class="flex flex-wrap items-center gap-2">
              <p class="text-xs uppercase tracking-wide text-zinc-500">Source Module</p>
    ...
    <div class="space-y-5 xl:col-span-4">
      <section class="rounded-lg border border-zinc-200 bg-white p-5" aria-labelledby="builder-overview-heading">
        <header class="border-b border-zinc-200 pb-4">
          <h2 id="builder-overview-heading" class="text-lg font-semibold text-zinc-900">Report Completeness</h2>
        </header>

        <dl class="mt-4 space-y-3">
          <div>
            <dt class="text-xs uppercase tracking-wide text-zinc-500">Report Completeness</dt>
            <dd class="mt-1 font-medium text-zinc-900">82%</dd>
          </div>
          <div>
            <dt class="text-xs uppercase tracking-wide text-zinc-500">Data Source Freshness</dt>
            <dd class="mt-1 font-medium text-zinc-900">Updated 2 hours ago</dd>
          </div>
          <div>
            <dt class="text-xs uppercase tracking-wide text-zinc-500">Open Clarifications Count</dt>
            <dd class="mt-1 font-medium text-negative-700">8</dd>
          </div>
          <div>
            <dt class="text-xs uppercase tracking-wide text-zinc-500">Evidence Under Review Count</dt>
            <dd class="mt-1 font-medium text-zinc-900">7</dd>
          </div>
          <div>
            <dt class="text-xs uppercase tracking-wide text-zinc-500">Missing Documents Count</dt>
            <dd class="mt-1 font-medium text-negative-700">5</dd>
          </div>
          <div>
            <dt class="text-xs uppercase tracking-wide text-zinc-500">Export Readiness Status</dt>
            <dd class="mt-1">
              <?php component('badge', ['items' => [['label' => 'Needs Update', 'tone' => 'warning']]]); ?>
            </dd>
          </div>
        </dl>
      </section>

      <section class="rounded-lg border border-zinc-200 bg-white p-5" aria-labelledby="builder-source-links-heading">
        <header class="border-b border-zinc-200 pb-4">
          <h2 id="builder-source-links-heading" class="text-lg font-semibold text-zinc-900">Source Data Links</h2>
        </header>
