...
<div class="stepper stepper--sm relative w-full" data-stepper data-stepper-min="0" data-stepper-max="20" data-stepper-step="1">
  ...
  <input class="stepper__number input input--sm h-[var(--ui-h-sm)] w-full rounded-lg bg-white px-11 text-center text-xs text-brand-900 ring-1 ring-brand-300 ring-inset focus:outline-none focus:ring-2 focus:ring-brand-500" type="text" value="2" inputmode="numeric" readonly data-stepper-number>
...
<div class="stepper stepper--md relative w-full" data-stepper data-stepper-min="1" data-stepper-max="30" data-stepper-step="1">
  ...
  <input class="stepper__number input input--md h-[var(--ui-h-md)] w-full rounded-lg bg-white px-12 text-center text-brand-900 ring-1 ring-brand-300 ring-inset focus:outline-none focus:ring-2 focus:ring-brand-500" type="text" value="10" inputmode="numeric" readonly data-stepper-number>
...
<div class="stepper stepper--lg relative w-full md:col-span-2" data-stepper data-stepper-min="0" data-stepper-max="50" data-stepper-step="5">
  ...
  <input class="stepper__number input input--lg h-[var(--ui-h-lg)] w-full rounded-lg bg-white px-14 text-center text-base text-brand-900 ring-1 ring-brand-300 ring-inset focus:outline-none focus:ring-2 focus:ring-brand-500" type="text" value="25" inputmode="numeric" readonly data-stepper-number>
