...
?>
<section class="rounded-lg border border-brand-200 bg-white p-5" aria-labelledby="submission-document-register-heading">
  <header class="flex items-start justify-between gap-3 border-b border-brand-200 pb-4">
    <h2 id="submission-document-register-heading" class="text-base font-semibold text-brand-900"><?= e($title); ?></h2>
