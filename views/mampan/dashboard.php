...
layout('mampan/partials/dashboard-start', [
  ...
  'dashboard_breadcrumb_items'  => isset($dashboard_breadcrumb_items) && is_array($dashboard_breadcrumb_items) ? $dashboard_breadcrumb_items : null,
  'dashboard_breadcrumb_description' => isset($dashboard_breadcrumb_description) ? (string) $dashboard_breadcrumb_description : '',
]);
