...
<section id="headers">
  <div class="space-y-2">
    <h2 class="text-xl font-bold text-brand-900">Headers</h2>
    <p class="max-w-3xl text-brand-600">
      Review hero, page, package, and section header variants in the dedicated Headers page.
    </p>
    <a
      href="/canvas/components/headers"
