...
?>
<section class="rounded-lg border border-zinc-200 bg-white p-4" aria-labelledby="clarification-filter-heading">
  <h2 id="clarification-filter-heading" class="text-sm font-semibold text-zinc-900">Filter Clarifications</h2>
