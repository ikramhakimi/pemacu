...
?>
<header class="rounded-lg border border-brand-200 bg-white p-5 md:p-6" aria-labelledby="gap-report-heading">
  <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
    <div>
      <p class="text-xs font-semibold uppercase tracking-wide text-brand-500">Gap Analysis Report</p>
      <h1 id="gap-report-heading" class="mt-2 text-2xl font-semibold leading-tight text-brand-900 md:text-3xl">
        <?= e($project_name); ?>
      </h1>
  ...
  <dl class="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
    ...
    <div>
      <dt class="text-xs uppercase tracking-wide text-brand-500">Report Type</dt>
      <dd class="mt-1 font-medium text-brand-900"><?= e($report_type); ?></dd>
    </div>
    <div>
      <dt class="text-xs uppercase tracking-wide text-brand-500">Report Version</dt>
      <dd class="mt-1 font-medium text-brand-900"><?= e($report_version); ?></dd>
    </div>
    <div>
