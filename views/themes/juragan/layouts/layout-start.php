...
$resolved_page_title   = isset($page_title) ? (string) $page_title : 'Juragan';
...
<head>
  ...
  <title><?= e($resolved_page_title); ?> | Juragan</title>
...
<body class="theme-juragan bg-white text-[14px] text-brand-700 font-sans leading-relaxed">
  <main id="root">
  <?php if (!$hide_nav): ?>
    <?php partial('nav', ['page_current' => $resolved_page_current]); ?>
  <?php endif; ?>
