 ...
 * - $dropdown_links: optional list of ['label' => string, 'href' => string] links.
...
<div class="dropdown relative inline-block" data-dropdown data-dropdown-align="<?= e($resolved_dropdown_align); ?>">
  ...
  <div
    ...
    class="dropdown__menu absolute <?= e($menu_position_class); ?> z-20 mt-2 hidden min-w-[220px] rounded-lg border border-brand-200 bg-white p-1 shadow-lg"
    role="menu"
  ...
  >
    <?php foreach ($resolved_dropdown_links as $dropdown_link): ?>
      ...
      ?>
      <a class="dropdown__item flex rounded-md px-3 py-2 text-sm text-brand-700 hover:bg-brand-100 hover:text-brand-900" href="<?= e($link_href); ?>" role="menuitem"><?= e($link_label); ?></a>
    <?php endforeach; ?>
  </div>
</div>
