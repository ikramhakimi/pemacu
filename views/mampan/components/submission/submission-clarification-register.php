...
$title            = isset($title) ? trim((string) $title) : 'Clarification Register';
...
?>
<section class="rounded-lg border border-brand-200 bg-white p-5" aria-labelledby="submission-clarification-register-heading">
  <header class="flex items-start justify-between gap-3 border-b border-brand-200 pb-4">
    <h2 id="submission-clarification-register-heading" class="text-base font-semibold text-brand-900"><?= e($title); ?></h2>
  ...
  <dl class="mt-4 grid grid-cols-2 gap-3 text-sm">
    <div class="rounded-md border border-brand-200 bg-brand-50 p-3">
      <dt class="text-xs uppercase tracking-wide text-brand-500">Completed</dt>
      <dd class="mt-1 font-semibold text-positive-700"><?= e($completed_count); ?></dd>
    </div>
    <div class="rounded-md border border-brand-200 bg-brand-50 p-3">
      <dt class="text-xs uppercase tracking-wide text-brand-500">Pending</dt>
      <dd class="mt-1 font-semibold text-attention-700"><?= e($pending_count); ?></dd>
    </div>
    <div class="rounded-md border border-brand-200 bg-brand-50 p-3 col-span-2">
      <dt class="text-xs uppercase tracking-wide text-brand-500">Issue Count</dt>
