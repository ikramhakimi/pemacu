...
?>
<section class="rounded-lg border border-zinc-200 bg-white p-5" aria-labelledby="submission-clarification-register-heading">
  <header class="flex items-start justify-between gap-3 border-b border-zinc-200 pb-4">
    <h2 id="submission-clarification-register-heading" class="text-base font-semibold text-zinc-900"><?= e($title); ?></h2>
