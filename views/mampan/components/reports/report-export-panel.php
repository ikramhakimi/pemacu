...
?>
<section class="rounded-lg border border-zinc-200 bg-white p-5" aria-labelledby="report-export-panel-heading">
  <header class="border-b border-zinc-200 pb-4">
    <h2 id="report-export-panel-heading" class="text-lg font-semibold text-zinc-900">Export Panel</h2>
  </header>

  <div class="mt-4 rounded-md border border-zinc-200 bg-zinc-50 p-3">
    <p class="text-xs uppercase tracking-wide text-zinc-500">Report Readiness</p>
    <p class="mt-1 font-medium text-zinc-900"><?= e($report_readiness); ?></p>
  </div>

  <div class="mt-4 grid gap-4 sm:grid-cols-2">
    <article>
      <h3 class="text-sm font-semibold text-zinc-900">Included Sections</h3>
    ...
    <article>
      <h3 class="text-sm font-semibold text-zinc-900">Missing Sections</h3>
      <ul class="mt-2 space-y-1 text-sm text-zinc-700">
  ...
  <div class="mt-4 border-t border-zinc-200 pt-4">
    <p class="text-xs uppercase tracking-wide text-zinc-500">Export Options</p>
