...
$resolved_breadcrumb_description     = isset($dashboard_breadcrumb_description) ? (string) $dashboard_breadcrumb_description : 'Portfolio-level management across all projects';
...
<article class="app-article py-5">
  <header class="rounded-lg border border-zinc-200 bg-white p-5">
    <div class="flex flex-wrap items-start justify-between gap-3">
      <div>
        <p class="text-xs font-semibold uppercase tracking-wide text-zinc-500">Mampan Consultant App</p>
