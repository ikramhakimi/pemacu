...
?>
<style>
  .table-ee th:first-child,
  .table-ee td:first-child {
    border-left: 0;
  }

  .table-ee th:last-child,
  .table-ee td:last-child {
    border-right: 0;
  }
  .table-ee > thead > tr > th {
    text-transform: uppercase;
    font-size: 12px;
  }
  .table-ee > thead > tr > th:first-child,
  .table-ee > tbody > tr > td:first-child {
    border-left: 0;
    padding-left: 16px;
  }

  .table-ee > thead > tr > th:last-child,
  .table-ee > tbody > tr > td:last-child {
    border-right: 0;
    padding-right: 16px;
    width: 40%;
  }

  .table-ee > tbody tbody td {
    border-bottom: 0;
  }

  .table-ee > tbody > tr:hover {
    background-color: oklch(98.5% 0.002 247.839);
  }

  .table-ee > thead > tr > th:nth-child(2),
  .table-ee > tbody > tr > td:nth-child(2),
  .table-ee > tfoot > tr > td:nth-child(2) {
    border-right: 0;
  }

  .table-ee > thead > tr > th:nth-child(3),
  .table-ee > tbody > tr > td:nth-child(3):not(.font-semibold) {
    border-left: 0;
  }

  .table-ee > tbody > tr > td[colspan="2"] table > tbody > tr > td:first-child {
    border-right: 0;
  }

  .table-ee > tbody > tr > td[colspan="2"] table > tbody > tr > td:nth-child(2) {
    border-left: 0;
  }
...
<article class="app-article max-w-7xl mx-auto">
  ...
  <section class="mt-8" aria-labelledby="assessment-summary-heading">
    ...
    <section class="<?php card('bg-brand-900 overflow-hidden mt-10 pb-1') ?>" aria-labelledby="assessment-category-heading">
      <header class="flex items-center p-5 gap-5 text-brand-400">
        <div class="flex items-center justify-center rounded-md bg-white text-brand-800">
          <div class="px-4 py-6">
            <?php component('icon', [
          ...
          <div class="text-brand-600 pr-3 text-center">
            <div data-ee-header-score>26</div>
            <div class="mt-1 pt-1 border-t border-brand-400" data-ee-header-max>35</div>
          </div>
        </div>
        <div>
          <h2 class="text-2xl text-white">Energy Efficiency (EE)</h2>
          <div class="mt-1">Design / Commissioning / Verification & Maintenance</div>
        </div>
      </header>
      ...
      <article>
        ...
        <div class="bg-white mx-1 rounded-md overflow-hidden">
          <table class="table-ee table-ee-design w-full border-collapse mb-5 border-b js-assessment-ee-table">
            <tbody>
              <tr class="row-eldest bg-brand-100 js-assessment-ee-row-eldest">
                <td colspan="5" class="p-4 border border-b-8 border-brand-300 text-brand-900 align-top font-bold text-base uppercase">
                  <div class="flex items-center justify-start gap-3">
                    <?php component('icon', [
                      'icon_name'  => 'flashlight-line',
                      'icon_size'  => '16',
                      'icon_class' => 'text-current opacity-60',
                    ]); ?>
                    <div>Design</div>
                  </div>
                </td>
              ...
              <tr data-ee-row data-ee-points="1">
                <td class="p-3 border border-brand-200 align-top">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-start uppercase font-bold">EE1</div>
                </td>
                <td class="p-3 border border-brand-200 align-top">
                ...
                <td class="p-3 border border-brand-200 align-top text-right" width="160">
                ...
                <td class="p-3 border border-brand-200 align-top text-right font-semibold" width="80">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-end gap-1" data-ee-total>0 <span class="font-normal text-brand-500">/ 1</span></div>
                </td>
                <td class="p-3 border border-brand-200 align-top font-semibold">
              ...
              <tr>
                <td class="p-3 border border-brand-200 align-top">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-start uppercase font-bold">EE2</div>
                </td>
                <td class="p-0 pt-3 pl-3 border border-brand-200 align-top" colspan="2">
                  ...
                  <table class="w-full border-collapse">
                    <tbody>
                      <tr class="border-t border-brand-200" data-ee-row data-ee-group="ee2" data-ee-points="1">
                ...
                <td class="p-3 border border-brand-200 align-top text-right font-semibold" width="80">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-end gap-1" data-ee-group-total="ee2">0 <span class="font-normal text-brand-500">/ 3</span></div>
                </td>
                <td class="p-3 border border-brand-200 align-top">
                  <div class="min-h-[var(--ui-h-md)] flex items-center justify-start">
              ...
              <tr data-ee-row data-ee-points="1">
                <td class="p-3 border border-brand-200 align-top">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-start uppercase font-bold">EE3</div>
                </td>
                <td class="p-3 border border-brand-200 align-top">
              ...
              <tr>
                <td class="p-3 border border-brand-200 align-top">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-start uppercase font-bold">EE4</div>
                </td>
                <td class="p-0 pt-3 pl-3 border border-brand-200 align-top" colspan="2">
                  ...
                  <table class="w-full border-collapse">
                    <tbody>
                      <tr class="border-t border-brand-200" data-ee-row data-ee-group="ee4" data-ee-exclusive-group="ee4" data-ee-points="2">
                        <td class="p-3 border border-brand-200">
                      ...
                      <tr class="border-t border-brand-200" data-ee-row data-ee-group="ee4" data-ee-exclusive-group="ee4" data-ee-points="3">
                        <td class="p-3 border border-brand-200">
                      ...
                      <tr class="border-t border-brand-200" data-ee-row data-ee-group="ee4" data-ee-exclusive-group="ee4" data-ee-points="4">
                        <td class="p-3 border border-brand-200">
                      ...
                      <tr class="border-t border-brand-200" data-ee-row data-ee-group="ee4" data-ee-exclusive-group="ee4" data-ee-points="5">
                        <td class="p-3 border border-brand-200">
                ...
                <td class="p-3 border border-brand-200 align-top text-right font-semibold" width="80">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-end gap-1" data-ee-group-total="ee4" data-ee-group-mode="max" data-ee-group-max="5">0 <span class="font-normal text-brand-500">/ 5</span></div>
                </td>
                <td class="p-3 border border-brand-200 align-top font-semibold">
                  <div class="min-h-[var(--ui-h-md)] flex items-center justify-start">
                    No remarks
              ...
              <tr>
                <td class="p-3 border border-brand-200 align-top">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-start uppercase font-bold">EE5</div>
                </td>
                <td class="p-0 pt-3 pl-3 border border-brand-200 align-top" colspan="2">
                  ...
                  <table class="w-full border-collapse mt-3">
                    <tbody>
                      <tr class="border-t border-brand-200" data-ee-row data-ee-group="ee5" data-ee-exclusive-group="ee5" data-ee-points="2">
                        <td class="p-3 border border-brand-200">
                      ...
                      <tr class="border-t border-brand-200" data-ee-row data-ee-group="ee5" data-ee-exclusive-group="ee5" data-ee-points="3">
                      ...
                      <tr class="border-t border-brand-200" data-ee-row data-ee-group="ee5" data-ee-exclusive-group="ee5" data-ee-points="5">
                      ...
                      <tr class="border-t border-brand-200" data-ee-row data-ee-group="ee5" data-ee-exclusive-group="ee5" data-ee-points="8">
                      ...
                      <tr class="border-t border-brand-200" data-ee-row data-ee-group="ee5" data-ee-exclusive-group="ee5" data-ee-points="10">
                      ...
                      <tr class="border-t border-brand-200" data-ee-row data-ee-group="ee5" data-ee-exclusive-group="ee5" data-ee-points="12">
                      ...
                      <tr class="border-t border-brand-200" data-ee-row data-ee-group="ee5" data-ee-exclusive-group="ee5" data-ee-points="15">
                ...
                <td class="p-3 border border-brand-200 align-top text-right font-semibold" width="80">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-end gap-1" data-ee-group-total="ee5" data-ee-group-mode="max" data-ee-group-max="15">0 <span class="font-normal text-brand-500">/ 15</span></div>
                </td>
                <td class="p-3 border border-brand-200 align-top font-semibold">
                  <div class="min-h-[var(--ui-h-md)] flex items-center justify-start">
                    No remarks
              ...
              <tr data-ee-row data-ee-points="3">
                <td class="p-3 border border-brand-200 align-top">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-start uppercase font-bold">EE6</div>
                </td>
                <td class="p-3 border border-brand-200 align-top">
                  <div class="uppercase font-bold h-[var(--ui-h-md)] flex items-center justify-start">
                ...
                <td class="p-3 border border-brand-200 align-top text-right font-semibold" width="80">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-end gap-1" data-ee-total>0 <span class="font-normal text-brand-500">/ 3</span></div>
                </td>
                <td class="p-3 border border-brand-200 align-top font-semibold">
                  <div class="min-h-[var(--ui-h-md)] flex items-center justify-start">
                    No remarks
              ...
              <tr>
                <td class="p-3 border border-brand-200 align-top">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-start uppercase font-bold">EE7</div>
                </td>
                <td class="p-0 pt-3 pl-3 border border-brand-200 align-top" colspan="2">
                  <div class="uppercase font-bold h-[var(--ui-h-md)] flex items-center justify-start">
                  ...
                  <table class="w-full border-collapse">
                    <tbody>
                      <tr class="border-t border-brand-200" data-ee-row data-ee-group="ee7" data-ee-points="1">
                        <td class="p-3 border border-brand-200">
                ...
                <td class="p-3 border border-brand-200 align-top text-right font-semibold" width="80">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-end gap-1" data-ee-group-total="ee7">0 <span class="font-normal text-brand-500">/ 2</span></div>
                </td>
                <td class="p-3 border border-brand-200 align-top font-semibold">
                  <div class="min-h-[var(--ui-h-md)] flex items-center justify-start">
                    No remarks
              ...
              <tr data-ee-row data-ee-points="2">
                <td class="p-3 border border-brand-200 align-top">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-start uppercase font-bold">EE8</div>
                </td>
                <td class="p-3 border border-brand-200 align-top">
                  <div class="uppercase font-bold h-[var(--ui-h-md)] flex items-center justify-start">
                    EE Verification
                ...
                <td class="p-3 border border-brand-200 align-top text-right font-semibold" width="80">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-end gap-1" data-ee-total>0 <span class="font-normal text-brand-500">/ 2</span></div>
                </td>
                <td class="p-3 border border-brand-200 align-top font-semibold">
                  <div class="min-h-[var(--ui-h-md)] flex items-center justify-start">
                    No remarks
              ...
              <tr>
                <td class="p-3 border border-brand-200 align-top">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-start uppercase font-bold">EE9</div>
                </td>
                <td class="p-0 pt-3 pl-3 border border-brand-200 align-top" colspan="2">
                  <div class="uppercase font-bold h-[var(--ui-h-md)] flex items-center justify-start">
                  ...
                  <table class="w-full border-collapse">
                    <tbody>
                      <tr class="border-t border-brand-200" data-ee-row data-ee-group="ee9" data-ee-points="1">
                        <td class="p-3 border border-brand-200">
                      ...
                      <tr class="border-t border-brand-200" data-ee-row data-ee-group="ee9" data-ee-points="2">
                        <td class="p-3 border border-brand-200">
                ...
                <td class="p-3 border border-brand-200 align-top text-right font-semibold" width="80">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-end gap-1" data-ee-group-total="ee9">0 <span class="font-normal text-brand-500">/ 3</span></div>
                </td>
                <td class="p-3 border border-brand-200 align-top font-semibold">
                  <div class="min-h-[var(--ui-h-md)] flex items-center justify-start">
                    No remarks
            ...
            <tfoot>
              <tr>
                ...
                <td class="p-3 border border-brand-200 align-top text-right font-semibold" width="80">
                  <div class="h-[var(--ui-h-md)] flex items-center justify-end gap-1" data-ee-table-total>0 <span class="font-normal text-brand-500">/ 0</span></div>
                </td>
                <td class="p-3 border border-brand-200 align-top font-semibold">
                  <div class="min-h-[var(--ui-h-md)] flex items-center justify-start">
                    Total score
    ...
    <script>
      (function () {
        var ee_table = document.querySelector('.js-assessment-ee-table');

        if (!ee_table) {
          return;
        }

        var ee_rows = ee_table.querySelectorAll('[data-ee-row]');
        var eldest_rows = ee_table.querySelectorAll('tbody > tr.js-assessment-ee-row-eldest');

        var setup_section_toggles = function () {
          eldest_rows.forEach(function (eldest_row) {
            var controlled_rows = [];
            var next_row = eldest_row.nextElementSibling;

            while (next_row && !next_row.classList.contains('js-assessment-ee-row-eldest')) {
            ...
            var header_wrap = eldest_row.querySelector('td > div');
            ...
            toggle_link.href = '#';
            toggle_link.className = 'row-eldest-toggle ml-auto text-xs font-semibold normal-case tracking-normal text-brand-600 hover:text-brand-800 underline';
            toggle_link.textContent = 'Hide section';
            toggle_link.setAttribute('aria-expanded', 'true');

            header_wrap.appendChild(toggle_link);
            ...
            toggle_link.addEventListener('click', function (event) {
              ...
              toggle_link.textContent = should_hide ? 'Show section' : 'Hide section';
              toggle_link.setAttribute('aria-expanded', should_hide ? 'false' : 'true');
            });
          });
        };

        var read_points = function (row) {
          var value = Number(row.getAttribute('data-ee-points') || 0);
        ...
        var update_row_total = function (row) {
          ...
          var total_node = row.querySelector('[data-ee-total]');
        ...
        var update_group_totals = function () {
          var group_total_nodes = ee_table.querySelectorAll('[data-ee-group-total]');

          group_total_nodes.forEach(function (group_total_node) {
            var group_name = group_total_node.getAttribute('data-ee-group-total');
            var group_mode = group_total_node.getAttribute('data-ee-group-mode');
            var group_max = Number(group_total_node.getAttribute('data-ee-group-max'));

            if (!group_name) {
              return;
            }

            var group_rows = ee_table.querySelectorAll('[data-ee-row][data-ee-group="' + group_name + '"]');
            var group_points = 0;
            var group_score = 0;
        ...
        var update_table_total = function () {
          var total_node = ee_table.querySelector('[data-ee-table-total]');
          var header_score_node = document.querySelector('[data-ee-header-score]');
          var header_max_node = document.querySelector('[data-ee-header-max]');

          if (!total_node) {
            return;
          }

          var all_rows = ee_table.querySelectorAll('[data-ee-row]');
          var group_map = {};
          var total_max = 0;
          var total_score = 0;

          all_rows.forEach(function (row) {
            var group_name = row.getAttribute('data-ee-group');
            var points = read_points(row);
            var checkbox = row.querySelector('input[type="checkbox"]');
            ...
            if (group_name) {
              ...
              var group_mode = row.getAttribute('data-ee-group-mode');
              if (!group_mode) {
                var group_total_node = ee_table.querySelector('[data-ee-group-total="' + group_name + '"]');
                group_mode = group_total_node ? group_total_node.getAttribute('data-ee-group-mode') : '';
              }
              ...
              var group_max_attr = row.getAttribute('data-ee-group-max');
              if (!group_max_attr) {
                var group_total = ee_table.querySelector('[data-ee-group-total="' + group_name + '"]');
                group_max_attr = group_total ? group_total.getAttribute('data-ee-group-max') : '';
              }
        ...
        ee_rows.forEach(function (row) {
          ...
          checkbox.addEventListener('change', function () {
            var exclusive_group = row.getAttribute('data-ee-exclusive-group');

            if (exclusive_group && checkbox.checked) {
              var exclusive_rows = ee_table.querySelectorAll('[data-ee-row][data-ee-exclusive-group="' + exclusive_group + '"]');
