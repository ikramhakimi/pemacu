...
?>
<section class="rounded-lg border border-zinc-200 bg-white p-5" aria-labelledby="submission-score-summary-heading">
  <header class="border-b border-zinc-200 pb-4">
    <h2 id="submission-score-summary-heading" class="text-lg font-semibold text-zinc-900">Score Summary</h2>
    <p class="mt-1 text-sm text-zinc-600">Final score confidence before package export and client sign-off.</p>
  </header>
  ...
  <dl class="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
    ...
    <div>
      <dt class="text-xs uppercase tracking-wide text-zinc-500">Rating Buffer</dt>
      <dd class="mt-1 font-medium text-zinc-900"><?= e($rating_buffer); ?></dd>
    </div>
    <div>
      <dt class="text-xs uppercase tracking-wide text-zinc-500">Final Recommendation</dt>
      <dd class="mt-1">
        <?php
